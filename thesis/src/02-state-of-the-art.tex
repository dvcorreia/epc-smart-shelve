...
In turn, GS1 established a new division called EPCglobal to implement Release 1.0 and to conduct further development based on industry input. This put forth an initial set of standards that formed the basis of an infra- structure for EPC data. Later, Auto-ID Release 1.0 became the starting-point for the EPCglobal Network~\cite[p. 50]{GlobalRFIDValue}. \todo[color=red]{rewrite}
...
The EPC may be encoded in a Radio Frequency Identification (RFID) tag but is not designed exclusively for use with RFID data carriers. For example, EPCs can also be constructed based on the reading of optical data carriers, such as linear barcodes. \todo[color=red]{Rewrite }

\todo[color=yellow,inline]{Codification}
\todo[color=yellow,inline]{Classes}
\todo[color=yellow,inline]{Gen 2 or ISO/IEC18000-6 Type C: ISO adoption of GS1's C1G2}
...
\todo[color=purple,inline]{Talk about LLRP for deployment of multiple readers e reader control and coordination?}
...
\todo[inline]{Video about food retail}
\todo[inline]{Video about supply chain}
